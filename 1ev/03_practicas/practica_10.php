<?php
    ...
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->SetLineWidth(1);
            $this->Cell($w,9,$nombre,0,1,'C',false);
            ...
            $this->SetX((210-$w_e)/2);
            $this->Cell($w_e,6,$email,0,1,'C',false);
            ...
            $this->Cell($w_c,6,$ciudad,0,0,'R',false);
            $this->Cell($w_s,6,'-',0,0,'C',false);
            $this->Cell($w_t,6,$telefono,0,0,'L',false);
            $this->Ln(15);
        }
        ...
        function Body($nombre, $empresa, $responsable, $fecha, $file)
        {
            ...
            $this->Cell(190,6,$empresa.", ".$fecha,0,1,'J',false);
            $this->Ln(10);
            $this->Cell(190,6,"Estimado Sr. $responsable",0,1,'J',false);
            $this->Ln(2);
            $txt = file_get_contents($file);
            $this->MultiCell(0,5,$txt,0,'J');
            $this->Ln(2);
            $this->Cell(190,6,"$nombre.",0,1,'J',false);
